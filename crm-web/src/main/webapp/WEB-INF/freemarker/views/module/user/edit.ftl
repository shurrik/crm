<div class="bjui-pageContent">
    <form action="${wwwroot}/admin/user/save" id="j_custom_form" data-toggle="validate" data-alertmsg="false" reloadNavtab="true">
                ...
                <tbody>
                    <tr>
                        <td>
                            ...
                            <input type="text" name="userName" id="userName" value="${(user.userName)!}" data-rule="required" >
                        </td>							
                        <td>
                            <label for="realName" class="control-label x85">真实姓名：</label>
                            <input type="text" name="realName" id="realName" value="${(user.realName)!}" data-rule="required" >
                        </td>							
                        <td>
                            <label for="password" class="control-label x85">密码：</label>
                            <input type="text" name="password" id="password" value="${(user.password)!}" data-rule="required" >
                        </td>							
					</tr>
					<tr>	
                        <td>
                            <label for="mobile" class="control-label x85">手机号：</label>
                            <input type="text" name="mobile" id="mobile" value="${(user.mobile)!}" data-rule="required" >
                        </td>							
                        <td>
                            <label for="email" class="control-label x85">邮箱：</label>
                            <input type="text" name="email" id="email" value="${(user.email)!}" data-rule="required" >
                        </td>
                        <#--							
                        <td>
                            <label for="depId" class="control-label x85">部门ID：</label>
                            <input type="text" name="depId" id="depId" value="${(user.depId)!}" data-rule="required" >
                        </td>
                        -->
                        <td>
